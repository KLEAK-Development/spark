    ...
    test('generates web entry for page with @Component classes', () async {
      await resolveSources(
        ...
        (resolver) async {
          ...
          // Check that it imports the page
          expect(output, contains('package:a/pages/home_page.dart'));
          ...
          // Check that it uses the page's components
          expect(output, contains('HomePage().components'));
        },
      );
    });
    ...
    test('generates web entry with hydration logic', () async {
      await resolveSources(
        ...
        (resolver) async {
          ...
          expect(output, contains('hydrateComponents'));
          expect(output, contains('Map.fromEntries'));
          expect(output, contains('ReactivePage().components'));
          expect(output, contains('MapEntry(c.tag, c.factory)'));
        },
      );
    });
