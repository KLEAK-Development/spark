...
''');
    ...
    buffer.writeln();
    buffer.writeln('    var cascade = Cascade();');
    buffer.writeln();
    buffer.writeln('    // 1. Static Assets');
    buffer.writeln('    cascade = cascade.add(createStaticHandler(');
    buffer.writeln('      staticPath,');
    buffer.writeln('      config: config!.staticConfig,');
    buffer.writeln('    ));');
    buffer.writeln();
    buffer.writeln('    // 2. Spark Pages & API');
    buffer.writeln('    cascade = cascade.add(router.call);');
    buffer.writeln();
