...
void main() {
  group('Browser Canvas', () {
    test('CanvasRenderingContext2D operations', () {
      final canvas = spark.document.createElement('canvas') as spark.HTMLCanvasElement;
      canvas.width = 200;
      canvas.height = 100;
      expect(canvas.width, 200);
      expect(canvas.height, 100);
      
      final ctx = canvas.getContext(spark.CanvasContextType.canvas2d) as spark.CanvasRenderingContext2D;
