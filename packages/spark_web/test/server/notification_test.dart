...
void main() {
  group('Server Notification', () {
    test('createNotification', () {
      final n = web.createNotification('Hello', const web.NotificationOptions(
        body: 'World',
        tag: 'foo',
        icon: 'bar.png',
        badge: 'baz.png',
    ...
    test('permission and actions', () async {
      expect(web.notificationPermission, web.NotificationPermission.defaultValue);
      expect(web.notificationMaxActions, 0);
      expect(await web.requestNotificationPermission(), web.NotificationPermission.defaultValue);
    });
  });
}
