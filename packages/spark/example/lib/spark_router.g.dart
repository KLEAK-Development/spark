...
import 'package:spark_example/pages/notification/notification_page.dart';
...
Future<Response> _$handleNotFoundPage(Request request) async {
...
Router createSparkRouter() {
  ...
  router.get('/api/users/<id>', (Request request, String id) =>
      _$handleGetUserEndpoint(request, id));
...
class SparkServerConfig {
  ...
  /// Page for 404 errors.
  final SparkPage<dynamic>? notFoundPage;
...
Future<HttpServer> createSparkServer([SparkServerConfig? config]) async {
  ...
  Handler createHandler() {
    ...
    } else if (config!.notFoundPage != null) {
      cascade = cascade.add((request) async {
        final page = config!.notFoundPage!;
